...
#define CF_PLUGIN_PC     0x00080000 /* Plugin metadata is tied to virtual PC */
...
#define CF_CLUSTER_SHIFT 24
    ...
    /* Guest physical fetch addresses, distinct from RAM backing offsets.
     * Entry 0 addresses the first byte; entry 1 addresses the second page.
     * They also distinguish physical aliases sharing one RAM backing page.
     */
    uint64_t guest_phys_addr[2];
    vaddr plugin_pc;
